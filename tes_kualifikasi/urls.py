...
urlpatterns = [
    ...
    #path('atlet-nonkualifikasi-ujian-kualifikasi/<uuid:id_atlet>/<int:tahun>/<int:batch>/<slug:tempat>/<slug:tanggal>/<bool:hasil_ujian/',
        #pertanyaan_kualifikasi_view, name='pertanyaan-kualifikasi'),
